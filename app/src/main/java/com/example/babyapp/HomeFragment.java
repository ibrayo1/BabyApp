...
//        // connect to this device via this mac address
//        mmDevice = mBluetoothAdapter.getRemoteDevice("00:14:03:06:81:42");
//        try{ // try to connect to the hc-05
//            openBT();
//        } catch (Exception e){
//            Toast.makeText(getContext(), "failed to connect", Toast.LENGTH_SHORT).show();
//        }
...
//            statistics.setVisibility(View.VISIBLE);
//            MainActivity.isBluetoothActive = true;
//            MainActivity.isThreadAlive = true;
//            Toast.makeText(getContext(), "Connected", Toast.LENGTH_SHORT).show();
//            beginListenForData();
//        }
//    }
...
//                    {
//                        stopWorker = true;
//                        MainActivity.isThreadAlive = false;
//                        MainActivity.isBluetoothActive = false;
//                    }
//                }
//            }
//        });
